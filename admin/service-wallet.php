            ...
            <div class="h-[calc(100vh-60px)] relative overflow-y-auto overflow-x-hidden p-4 space-y-4 detached-content">
                <nav class="w-full">
                    <ul class="space-y-2 detached-breadcrumb">
                        ...
                        <li class="text-xl font-semibold text-slate-800 dark:text-slate-100">Service Wallet</li>
                    </ul>
                </nav>
                <!-- Start All Card -->
                <div class="flex flex-col gap-4 min-h-[calc(100vh-212px)]">
                    <div class="grid grid-cols-1 gap-4">
                        <div class="card">
                            <form action="service-wallet" method="post">
                            ...
                            <h2 class="mb-4 text-base font-semibold capitalize text-slate-800 dark:text-slate-100">Recharge Service Balance</h2>
                                <div class="space-y-1">
