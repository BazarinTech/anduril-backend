                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <h2 class="mb-4 text-base font-semibold capitalize text-slate-800 dark:text-slate-100">Orders Records</h2>
                            ...
                            data_table([
                                ...
                                'rows'       => $orders_records,
                                'key'        => 'id',
                                'update'     => 'actions/update_orders.php',
                                'resource'   => 'orders',
                                'can_edit'   => $isEdit,
                                'can_delete' => $isEdit,
                                'search'     => ['name', 'user', 'status'],
                                'empty'      => 'No investment orders yet.',
                                'columns'    => [
                                    ['label' => '#',    'field' => 'id'],
                                    ['label' => 'Product Name', 'field' => 'name',
                                     'hint'  => 'The product this order was placed against. Change it on the Products page.'],
                                    ['label' => 'User', 'field' => 'user',
                                     'hint'  => 'Owner of the order, joined in from users. Orders cannot be reassigned.'],
                                    ['label' => 'Price',  'field' => 'price',  'numeric' => true,
                                     'hint'  => 'Amount paid when the order was placed.'],
                                    ['label' => 'Income', 'field' => 'income', 'numeric' => true,
                                     'hint'  => 'Accrued return. Adjusting it by hand would desync the wallet, so it is read-only.'],
                                    ['label' => 'Status', 'field' => 'status', 'edit' => 'status',
                                     'type'  => 'select',
                                     'options' => ['Active' => 'Active', 'Expired' => 'Expired', 'inactive' => 'Inactive'],
                                     'badge' => ['Active' => 'success', 'Expired' => 'warning', '*' => 'danger']],
                                    ['label' => 'Time', 'field' => 'time',
                                     'hint'  => 'Recorded when the order was placed.'],
                                ],
                            ]);
                            ?>
                        </div>
