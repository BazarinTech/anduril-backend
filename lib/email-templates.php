...
if (!function_exists('registration_template')) {
...
if (!function_exists('login_template')) {
...
if (!function_exists('pending_withdrawal_template')) {
...
if (!function_exists('deposit_template')) {
...
if (!function_exists('success_withdrawal_template')) {
...
if (!function_exists('declined_withdrawal_template')) {
